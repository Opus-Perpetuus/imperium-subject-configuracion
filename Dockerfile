...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-configuracion"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-configuracion"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-configuracion \
    KIRLET_TECHNICAL_ID=subject-configuracion \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
